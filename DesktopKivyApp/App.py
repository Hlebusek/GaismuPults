...
Builder.load_file("./data/KV/AddWindow.kv")
Builder.load_file("./data/KV/main.kv")
Builder.load_file("./data/KV/RecordWindow.kv")
...
class MainWindow(Widget):
    ...
    def __init__(self, **kwargs):
        ...
        with self.canvas.before:
            Rectangle(source='./data/Images/Background2.png', pos=self.pos, size = Window.size)
        ...
        for i in range(10):
            ...
            Sliders.append([
                Slider(disabled=True,value_track_color=(0,0,0,1),cursor_disabled_image = "./data/Images/SliderCursor.png",cursor_image = "./data/Images/SliderCursor.png",background_width="100sp",cursor_size =("30sp","40sp"),sensitivity = "all",min=0, max=255, value=0,orientation = "vertical",value_track = True,size_hint = (None,None), height = SliderLayout.height*0.8, step = 1),
